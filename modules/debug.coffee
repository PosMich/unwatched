...
style.error       = "#{sty.bgwhite sty.black config.appName} " +
                    "#{sty.red sty.bold 'ERROR:'} "
style.warn        = "#{sty.bgwhite sty.black config.appName} " +
                    "#{sty.yellow 'WARNING:'} "
style.info        = "#{sty.bgwhite sty.black config.appName} " +
                    "#{sty.cyan 'INFO:'} "
