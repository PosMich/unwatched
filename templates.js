angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/404.jade',
    "doctype html\n" +
    "html\n" +
    "  head\n" +
    "    title #{title} - My Site\n" +
  ...
  $templateCache.put('views/layout.jade',
    ...
    "    link(type='text/css', rel='stylesheet', href='/css/app.css')\n" +
    "  body\n" +
    "    .sidenav-container(onmousedown=\"return false\")\n" +
    "      .sidenav\n" +
    "        .icon-align\n" +
    "          .icon-container\n" +
    "            a.menu-home.side-icon(href=\"/\").side-tooltip\n" +
    "              .side-popover\n" +
    "                .arrow\n" +
    "                .content home\n" +
    "            .subicons-container\n" +
    ...
    "                  a.menu-tutorial.subicon(href=\"/tutorial\").side-tooltip\n" +
    "                    .side-popover\n" +
    "                      .arrow\n" +
    "                      .content Tutorial\n" +
    ...
    "                  a.menu-leave-room.subicon(href=\"/leaveRoom\").side-tooltip\n" +
    ...
    "            .clearfix\n" +
    "          .icon-container\n" +
    "            a.menu-user.side-icon(href=\"/members\").side-tooltip\n" +
    "              .notification 10\n" +
    "              .side-popover\n" +
    "                .arrow\n" +
    "                .content show/invite members\n" +
    "            .subicons-container\n" +
    "              .subicons\n" +
    "                .subicon-container.top2\n" +
    ...
    "                        span bla bla blaasd aaaa f....\n" +
    "                      .history-entry\n" +
    "                        img(src=\"https://cdn1.iconfinder.com/data/icons/iconshock_guys/512/matthew.png\")\n" +
    "                        span bla blaasd aaaa f....\n" +
    "                      .history-entry\n" +
    "                        img(src=\"http://icons.iconarchive.com/icons/hopstarter/superhero-avatar/256/Avengers-Black-Widow-icon.png\")\n" +
    "                        span bla bla blaasd aaaa f....\n" +
    "                      .history-entry\n" +
    "                        img(src=\"http://png-4.findicons.com/files/icons/175/halloween_avatar/256/jack_skellington.png\")\n" +
    "                        span bla bla bla....\n" +
    "          .icon-container\n" +
    ...
    "                .subicon-container.bottom1\n" +
    "                  a.menu-share-file.subicon(href=\"/share/files\").side-tooltip\n" +
    "                    .side-popover\n" +
    "                      .arrow\n" +
  ...
  $templateCache.put('views/partials/chat.jade',
  ...
  $templateCache.put('views/partials/index.jade',
  ...
  $templateCache.put('views/partials/items/code.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail(ng-class=\"item.extension\")\n" +
    "        .content\n" +
    "            h3 {{item.name}}.{{item.extension}}\n" +
    "            p\n" +
    "                code(ng-bind-html=\"item.thumbnail\")\n" +
    "    .item-infos(ng-class=\"item.extension\")\n" +
    "        table\n" +
    "            tr\n" +
    "                td\n" +
    "                    b Name\n" +
  ...
  $templateCache.put('views/partials/items/file.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail\n" +
    "        .infos\n" +
    "            table\n" +
  ...
  $templateCache.put('views/partials/items/note.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail\n" +
    "        h3 {{item.thumbnail.title}}\n" +
    "        .content(ng-bind-html=\"item.thumbnail.content\")\n" +
    "    .item-infos\n" +
    "        table\n" +
    "            tr\n" +
    "                td\n" +
  ...
  $templateCache.put('views/partials/items/screenshot.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail(style=\"background-image: url(images/{{item.thumbnail}})\")\n" +
    "    .item-infos\n" +
    "        table\n" +
    "            tr\n" +
    "                td\n" +
  ...
  $templateCache.put('views/partials/items/shared-screen.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail(style=\"background-image: url(images/{{item.thumbnail}})\")\n" +
    "    .item-infos\n" +
    "        table\n" +
  ...
  $templateCache.put('views/partials/items/shared-webcam.jade',
    ".item(class=\"{{item.category}}\")\n" +
    "    .item-thumbnail(style=\"background-image: url(images/{{item.thumbnail}})\")\n" +
    "    .item-infos\n" +
    "        table\n" +
  ...
  $templateCache.put('views/partials/loginForm.jade',
    ".modal-header\n" +
    "  h3 Login\n" +
    ".modal-body\n" +
    "  fieldset\n" +
  ...
  $templateCache.put('views/partials/member.jade',
    "img(src=\"{{member.avatar}}\")"
  );


  $templateCache.put('views/partials/members.jade',
    ".row\n" +
    "    .member-container\n" +
    "        .member(member, ng-repeat=\"member in members\",\n" +
    "            ng-class=\"{'col-lg-2 col-md-3 col-sm-4':chat_state!='expanded', 'col-lg-3 col-md-4 col-sm-6':chat_state=='expanded'}\")\n" +
    "                "
  );


  $templateCache.put('views/partials/room.jade',
    "\n" +
    "\n" +
    "\n" +
    "\n" +
  ...
  $templateCache.put('views/partials/share.jade',
  ...
  $templateCache.put('views/partials/spacelab.jade',
    "#banner.page-header\n" +
    "  .row\n" +
    "    .col-lg-6\n" +
    "      h1 Cyborg\n" +
  ...
  $templateCache.put('views/partials/test.jade',
    ".test test\n"
  );
